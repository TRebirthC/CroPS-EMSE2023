...
class MicroCluster:
    ...
    def class_bias(self, prob_mc, prob_data):
        ...
        :param prob_data: probability of the entire Fea14_org of being label 0 or 1.
    ...
    def directed_distance_probs(self, prob_mc, prob_data):
        ...
        :param prob_data: probability in the while Fea14_org for a certain label 0/1
    ...
    def weight_to_1point(self, data_1point, temperature=10):
        """ Compute the weight of micro-cluster Cj to determine CL of Fea14_org Xi with two factors:
        ...
        """1) distance betw Fea14_org Xi and micro-cluster Cj
        """
        eu_distance = self.distance_to_point(data_1point)
        option_ = 1  # TODO 2021-11-24
        if option_ == 0:
            dis_X_C = eu_distance
        ...
        hyper-para temperature T: larger T can enlarge the differentiation among data"""
        ...
        # TODO 2021-11-24 remove time factor? 12-1 No, retain this but in the division formation of T
        # self.weight() - beta_mu TODO
        # up_to_date = math.exp(-time_decay * up_to_date)
        T2 = temperature
