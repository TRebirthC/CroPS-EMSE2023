"""
This file is related to the base JIT-SDP model OOB.
...
class OzaBaggingClassifier_OOB(BaseSKMObject, ClassifierMixin, MetaEstimatorMixin):
    ...
    def __init__(self, base_estimator=KNNADWINClassifier(), n_estimators=10, random_state=None, theta_imb=0.9):
        super().__init__()
        # default values
        self.ensemble = None
